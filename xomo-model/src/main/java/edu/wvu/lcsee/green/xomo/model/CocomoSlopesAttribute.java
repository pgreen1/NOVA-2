...
public class CocomoSlopesAttribute {
  ...
  public static final Attribute<Double> SF_EFFORT_COEFFICIENT_SLOPE = new DefaultAttribute<Double>(
          "SF_EFFORT_COEFFICENT_SLOPE", "Slope for effort coefficient for SF", Double.class);
  public static final Attribute<Double> EM_PLUS_EFFORT_COEFFICIENT_SLOPE = new DefaultAttribute<Double>(
          "EM_PLUS_EFFORT_COEFFICENT_SLOPE", "Slope for effort coefficient for EM with positive correlation",
          Double.class);
  public static final Attribute<Double> EM_MINUS_EFFORT_COEFFICIENT_SLOPE = new DefaultAttribute<Double>(
