 ...
 * @author pdgreen
 */
public class ScaleFactorValueImpl implements ScaleFactorValue {
  ...
  ScaleFactorValueImpl(@Nonnull final CocomoLevel level, @Nonnull final double effortCoefficent,
